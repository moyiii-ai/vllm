...
# Shared by both embedded vLLM instances (each mounts GLOBAL_SEGMENT_SIZE).
#
...
echo "  (each contributes embedded Mooncake DRAM=$GLOBAL_SEGMENT_SIZE, Put-pinned to own segment)"
